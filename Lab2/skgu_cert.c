...
cert* cert_init(const dckey *is, const char *id, const dckey *pub,
        unsigned int ndays)
{
    cert *res = NULL;
...
int cert_sign_n_write(const dckey *ca, const char *id, const dckey *pub,
